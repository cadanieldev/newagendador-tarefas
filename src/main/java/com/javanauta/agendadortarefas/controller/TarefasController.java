...
public class TarefasController {
    ...
    @PostMapping
    public ResponseEntity<TarefasDTORecord> gravarTarefas(@RequestBody TarefasDTORecord dto, @RequestHeader
    ...
    @PatchMapping
    public ResponseEntity<TarefasDTORecord> alteraStatusNotificao(@RequestParam("status")StatusNotificacaoEnum status,
